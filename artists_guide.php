...
<body class="guide-background">
           ...
           <p class="word2">
                        1. Register and upload your artwork on <a style="color:#f2f2f2;" href="home.php">ART CART.</a><br>
                        2. Ship the artwork to the buyer.<br>
                        3. Receive 80% of the selling price.<br>
            </p>

            <h3 class="word1">How do I apply to exhibit my artwork at ART CART?</h3>
            ...
            <h3 class="word1">If I exhibit my work at ART CART, may I seek other gallery representation?</h3>
                <p class="word2">Yes.</p>
            ...
            <h3 class="word1">Can clients living outside of the United States purchase my art on ART CART?</h3>
                <p class="word2">No! We don't allow international customers.</p>

            <h3 class="word1">How do I submit more art if I am already exhibiting my work at ART CART?</h3>
